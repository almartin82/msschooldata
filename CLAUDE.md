...
| Python tests | `pytest tests/test_pymsschooldata.py -v`                                       | Python wrapper works correctly                 |
...
system("pip install -e ./pymsschooldata && pytest tests/test_pymsschooldata.py -v")
...
warnings - \[ \] `pytest tests/test_pymsschooldata.py` — all tests
pass - \[ \]
