...
project](https://github.com/almartin82/njschooldata), which began with
New Jersey and has expanded to cover all 50 states. The goal is simple:
make state education data accessible, consistent, and easy to analyze.

Mississippi’s education landscape tells a unique story - from the
demographic patterns of the Delta to the suburban growth around Jackson
and Memphis. This package gives you direct access to 18 years of
enrollment data straight from the Mississippi Department of Education.

**18 years of enrollment data (2007-2024).** 440,000 students. 144
districts. Here are 15 stories hiding in the numbers.
...
![Mississippi Has Many Majority-Black
Districts](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/majority-black-1.png)
...
Out](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/delta-decline-1.png)
...
![DeSoto County
Growth](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/desoto-growth-1.png)
...
Decline](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/jackson-decline-1.png)
...
Rates](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/econ-disadvantage-1.png)

Economic Disadvantage Rates
...
![COVID Impact on
Kindergarten](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/covid-k-1.png)
...
![Madison County
Growth](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/madison-growth-1.png)
...
![Hispanic Population
Growth](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/hispanic-growth-1.png)
...
![Gulf Coast
Enrollment](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/coast-stable-1.png)
...
![State Enrollment
Trend](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/state-trend-1.png)
...
![Top 15
Districts](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/top-districts-1.png)
...
![Racial
Demographics](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/racial-breakdown-1.png)
...
![Rankin County
Growth](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/rankin-growth-1.png)
...
![Gender
Balance](https://almartin82.github.io/msschooldata/articles/enrollment-trends_files/figure-html/gender-balance-1.png)
...
All data comes directly from the **Mississippi Department of Education
(MDE)**:
...
- **Census Day:** October 1 counts via Mississippi Student Information
  System (MSIS)
...
- Some district names have changed over time (consolidations,
  reorganizations)
...
This package is part of a larger effort to make state education data
accessible. The project started with
[njschooldata](https://github.com/almartin82/njschooldata) (New Jersey)
and has expanded to cover all 50 states.
